...
public class SimpleConverter {
    ...
    public SimpleConverter(int precision) {
        this.precision = precision;
    }

    public String binToDec(String bin) {
        BigDecimalCover bdc = new BigDecimalCover(0);
        String sum = "0";
    ...
    public String gradToRadian(String grad) {
        BigDecimalCover bdc = new BigDecimalCover(this.precision);
        String nominator = bdc.multiply(grad, BigDecimalCover.PI);
    ...
    public String radianToGrad(String radian) {
        ...
        return bdc.divide(nominator, BigDecimalCover.PI);
    }
}